; ModuleID = 'Arduino/HardwareSerial2.cpp'
source_filename = "Arduino/HardwareSerial2.cpp"
...
!1 = !DIFile(filename: "Arduino/HardwareSerial2.cpp", directory: "/Users/dylan/projects/llvm-project/standalone-arduino")
!2 = !{}
